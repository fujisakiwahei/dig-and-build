...
Dig&Buildは、ニュース速報型ではなく読み物メディアなので、SSGと相性が良い。

理由は、記事更新がリアルタイムである必要が低く、表示速度とSEOを優先できるため。

## 一言まとめ

SSGは、ユーザーが来た時にデータを取りに行くのではなく、あらかじめビルド時にデータを取得してHTMLを作っておく仕組み。

今回のDig&Buildでは、この設計で問題ない。
